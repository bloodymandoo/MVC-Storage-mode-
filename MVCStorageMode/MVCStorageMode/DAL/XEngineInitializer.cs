    ...
    public class XEngineInitializer:System.Data.Entity.DropCreateDatabaseIfModelChanges<XEngineContext>
    {
        protected override void Seed(XEngineContext context)
        {
            var sysUsers = new List<SysUser>{
                ...
                new SysUser{ID=2,Name="LS",CName="李四",Email="ls@xengine.com",Password="2",ModifiedDate=DateTime.Now},
                new SysUser{ID=3,Name="WW",CName="王五",Email="ww@xengine.com",Password="3",ModifiedDate=DateTime.Now}
            };
            ...
            var sysRoles = new List<SysRole>{
                ...
                Description="Administrators have full authorization to perform system administration.",ModifiedDate=DateTime.Now
                },
